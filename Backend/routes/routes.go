...
router.HandleFunc("/users/{id}/contract", controllers.UploadContractHandler).Methods("POST")
router.HandleFunc("/users/{id}/download", controllers.DownloadContractHandler).Methods("GET")
